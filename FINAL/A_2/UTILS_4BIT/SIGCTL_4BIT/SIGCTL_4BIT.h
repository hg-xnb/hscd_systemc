...
SC_MODULE(SIGCTL_4BIT)
{
    ...
    SC_CTOR(SIGCTL_4BIT) : EN("EN"), RST("RST"), A("A"), B("B"), 
    SELECT("SELECT"), FS_RST("FS_RST"), FA_RST("FA_RST"), 
    AND_RST("AND_RST"), NAND_RST("NAND_RST"),    OR_RST("OR_RST"), 
    XOR_RST("XOR_RST"),    FS_EN("FS_EN"), FA_EN("FA_EN"), 
    AND_EN("AND_EN"), NAND_EN("NAND_EN"),    OR_EN("OR_EN"),
    XOR_EN("XOR_EN"), OUT_MUX_EN("OUT_MUX_EN"), FS_B_IN("FS_B_IN"), 
    FA_C_IN("FA_C_IN"), FS_A("FS_A"), FA_A("FA_A"), AND_A("AND_A"), 
    NAND_A("NAND_A"), OR_A("OR_A"), XOR_A("XOR_A"), FS_B("FS_B"), 
    FA_B("FA_B"), AND_B("AND_B"), NAND_B("NAND_B"), OR_B("OR_B"),
    XOR_B("XOR_B"),
